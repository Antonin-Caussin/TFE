# Initialisation et chargement des packages
...
desc::desc_set_authors(c(
  person(
    ...
    "Caussin",
    role = c("aut", "cre"),
    email = "antonin.caussin@student.uliege.be"
  ),
  person(
    family = "Université de Liège Gemblou Agro-Bio",
    role = "cph"
  )
))
# Décrire ce que fait le package
desc::desc_set(
  Description = "Package afin de determiner le volume de bois d'oeuvre, volume résiduel et la biomasse des principales essences forestieres"
)
# Choisir une licence
...
repo_url <- "https://gitlab.com/Antonin-Caussin/TFE.git"
